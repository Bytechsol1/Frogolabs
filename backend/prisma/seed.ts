...
async function main() {
    ...
    // ── Clinic 3: Westside Health Center ─────────────────────────
    ...
    // ── Helper: create patient + workflow ────────────────────────
    async function seedPatient(
        clinicId: string,
        p: { first_name: string; last_name: string; email: string; phone: string; dob: string },
        test_type: string,
        status: string,
    ) {
